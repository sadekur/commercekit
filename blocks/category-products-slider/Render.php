...
<div id="<?php echo esc_attr( $uid ); ?>" class="ck-csl-wrap ck-csl-layout-<?php echo esc_attr( $layout ); ?> w-full">
    ...
    // ── Child Under Parent — integrated card (parent image + children pills inside one card)
            ...
            <div class="ck-csl-cup-details flex-1" style="padding:<?php echo $pad; ?>">
                ...
                <div class="ck-csl-cat-name" style="margin-top:<?php echo esc_attr( $name_mt ); ?>px">
                    <a href="<?php echo esc_url( $p_link ); ?>"
                       class="ck-csl-cup-parent-link no-underline leading-[1.3]">
